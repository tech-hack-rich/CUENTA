...
- ヘッダーの右のボタンは、ユーザーのログイン状態によって、表示を変えています。ログイン状態では、ユーザーの名前と口座作成ボタン（CUENTA作成ボタン）が表示されており、そこから作成ページへと遷移できます。
...
- 気軽に利用していただけるように、ユーザーの新規登録は最低限の情報でできるようにしいます。
...
- トップ部分には、一番新しい資産額と投資額の情報と、それに基づいて、利益を表示するようにしています。
