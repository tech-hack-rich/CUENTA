...
# 制作背景(意図)
今回は投資初心者にやしい資産管理アプリを作ろうと思いました。今現在、日本では老後2,000万円問題などがあり、投資に関心のある若者がとても増えています。そんな中、投資初心者には資産管理アプリがないと管理が難しいため、初心者が使いやすい資産管理アプリを探していましたが、なかなか思うような物がないことに気づき、作ろうと思いました。
